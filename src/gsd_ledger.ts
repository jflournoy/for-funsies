...
function buildRow(
  ...
  return `| ${num} | ${date} | ${contributor} | \`${kind}\` | [#${pr}](https://github.com/jflournoy/for-funsies/pull/${pr}) | [#${issue}](https://github.com/jflournoy/for-funsies/issues/${issue}) | ${amount} | ${denomination} | ${notes} |`;
}
